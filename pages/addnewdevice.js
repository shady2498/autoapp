...
export default function addnewdevice() {
	return (
        ...
        <p className="P-Nonotifications">Here is something information that you must to know.</p>
        
        <div  className="row unknown devices">
        <div className="col-sm-5">

      <div className="card-body">
        <img src=".\img\louis-tricot-rHk5uvsnCn4-unsplash.jpg" class="img-fluid" alt="Responsive image"/>
      </div>
